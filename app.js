...
// makeApiCall
//             // let minPrize = result.filters.rangeFilters[0].start;
//             // let maxPrize = result.filters.rangeFilters[0].end;
            // console.log(result.filters);
            // console.log("length of the products array "+result.products.length);
